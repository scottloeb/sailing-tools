      ...
      <div style={{ 
        ...
        <div>
          ...
          <div style={{ marginBottom: '0.08in' }}>
            ...
            <p style={{ margin: '0.015in 0', fontSize: '0.12in' }}>
        ...
        <div>
          ...
          <div style={{ marginBottom: '0.08in' }}>
            ...
            <ul style={{ 
              margin: '0.01in 0 0 0.12in', 
              paddingLeft: '0', 
              fontSize: '0.12in',
              listStyleType: 'none'
            }}>
              <li style={{ marginBottom: '0.01in' }}>• "?" = Don't understand yet</li>
              <li style={{ marginBottom: '0.01in' }}>• "big" = Complex project</li>
              <li style={{ marginBottom: '0.01in' }}>• [Location] or (Person) = Context</li>
              <li style={{ marginBottom: '0.01in' }}>• <strong>Temperature</strong> = Importance level</li>
              <li style={{ marginBottom: '0.01in' }}>• <strong>Due Date</strong> = Firm deadline</li>
              <li style={{ marginBottom: '0.01in' }}>• <strong>Task Date</strong> = Scheduled completion</li>
            </ul>
          </div>
